...
function Header() {
    ...
    return (
        <div className={`sticky top-0 backdrop-blur-xl bg-[#FFFFFFCC] border-b-2 border-b-slate-100 shadow-sm z-[100]`}>
            <div className="max-w-5xl mx-auto p-4 flex flex-row items-center">
                <Link href={"/"}>
